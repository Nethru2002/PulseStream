...
class PulseStreamApp(ctk.CTk):
    ...
    def setup_layout(self):
        ...
        self.player_bar = ctk.CTkFrame(self.main_frame, height=120, fg_color="#181818", 
                                       corner_radius=30, border_width=1, border_color="#282828",
                                       bg_color="#121212")
        ...
        self.progress_slider = ctk.CTkSlider(self.player_bar, from_=0, to=100, height=16, 
                                             progress_color="#1DB954", fg_color="#333333",
                                             bg_color="#181818")
        ...
        self.play_btn = ctk.CTkButton(mid_ctrls, text="▶", width=56, height=56, corner_radius=28, 
                                      fg_color="white", text_color="black", font=("Arial", 20, "bold"), 
        ...
        ctk.CTkButton(mid_ctrls, text="⏸", width=40, height=40, fg_color="transparent", 
                      ...
                      command=self.player.toggle_pause).pack(side="left")
    ...
    def add_files(self):
        f = filedialog.askopenfilenames(); [self.playlist_data.append({"title": os.path.basename(x), "path": x}) for x in f]
        self.refresh_list()
    ...
    def identify_song(self):
        messagebox.showinfo("Pulse", "Listening...")
        def task():
            t = "id_cache.wav"; self.recorder.record(t)
            res = asyncio.run(self.recognizer.identify(t))
            if 'track' in res: messagebox.showinfo("Found", res['track']['title'])
